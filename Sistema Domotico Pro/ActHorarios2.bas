...
Sub Globals
	...
	Type Horario(Hora As Byte  , Minuto As Byte , Circuito As Byte , Salida As Int )
...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.AddMenuItem(ValoresComunes.GetLanString ("SWP"), "mnuDias")
...
Sub SelectDays
	Dim ResultDays As List 
	
	Dim m As Map
	m.Initialize
	ResultDays.Initialize 
	

	
	If Days.IndexOf (0)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("reg51"), True)
	Else
		m.Put(ValoresComunes.GetLanString  ("reg51"), False)
	End If
		If Days.IndexOf (1)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("reg52"), True)
	Else
		m.Put(ValoresComunes.GetLanString  ("reg52"), False)
	End If
		If Days.IndexOf (2)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("reg53"), True)
	Else
		m.Put(ValoresComunes.GetLanString  ("reg53"), False)
	End If
	If Days.IndexOf (3)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("reg54"), True)
	Else
		m.Put(ValoresComunes.GetLanString  ("reg54"), False)
	End If
	If Days.IndexOf (4)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("reg55"), True)
	Else
		m.Put(ValoresComunes.GetLanString  ("reg55"), False)
	End If
	If Days.IndexOf (5)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("reg56"), True)
	Else
		m.Put(ValoresComunes.GetLanString  ("reg56"), False)
	End If
	If Days.IndexOf (6)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("reg57"), True)
	Else
		m.Put(ValoresComunes.GetLanString  ("reg57"), False)
	End If
	If Days.IndexOf (7)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("SPDI")& " 1", True)
	Else
		m.Put(ValoresComunes.GetLanString  ("SPDI")& " 1", False)
	End If
	If Days.IndexOf (8)>-1 Then 
		m.Put(ValoresComunes.GetLanString  ("SPDI")& " 2", True)
	Else
		m.Put(ValoresComunes.GetLanString  ("SPDI")& " 2", False)
	End If

	
	InputMap  (   m,ValoresComunes.GetLanString ("reg75"))
	Dim c As Int 
		
	For c=0 To m.Size -1
		If m.GetValueAt (c) Then	ResultDays.Add (c)
		
	Next
	
	
	If ResultDays.Size >0 Then
		Days=ResultDays
		writeTitle
	Else
...
Sub mnuSave_Click
	If EnableMenu Then
		...
		If Rsp = DialogResponse.POSITIVE Then
			Dim c As Int
			If Dias.IsInitialized =False Then
				Dias.Initialize
			Else
				Dias.Clear
			End If
		
			For c=0 To Days.Size -1
				Dias.Add (Days.Get (c))
			Next
...
Sub writeTitle
	...
	Else 
		...
		If Days.IndexOf (0)>-1 Then t=	ValoresComunes.GetLanString ("reg58") & ", "
		If Days.IndexOf (1)>-1 Then t=t &	ValoresComunes.GetLanString ("reg59") & ", "
		If Days.IndexOf (2)>-1 Then t=t &	ValoresComunes.GetLanString ("reg60") & ", "
		If Days.IndexOf (3)>-1 Then t=t &	ValoresComunes.GetLanString ("reg61") & ", "
		If Days.IndexOf (4)>-1 Then t=t &	ValoresComunes.GetLanString ("reg62") & ", "
		If Days.IndexOf (5)>-1 Then t=t &	ValoresComunes.GetLanString ("reg63") & ", "
		If Days.IndexOf (6)>-1 Then t=t &	"Sp1" & ", "
		If Days.IndexOf (6)>-1 Then t=t &	"Sp2" & ", "
