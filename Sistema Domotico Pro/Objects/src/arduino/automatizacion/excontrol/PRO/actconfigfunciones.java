...
public class actconfigfunciones extends Activity implements B4AActivity{
	public static actconfigfunciones mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigfunciones");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actconfigfunciones).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigfunciones");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "arduino.automatizacion.excontrol.PRO.actconfigfunciones", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actconfigfunciones) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actconfigfunciones) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return actconfigfunciones.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actconfigfunciones) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _he = 0;
 ...
 //BA.debugLineNum = 20;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = Fals";
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 21;BA.debugLine="Activity.LoadLayout (\"frmconfig\")";
mostCurrent._activity.LoadLayout("frmconfig",mostCurrent.activityBA);
 //BA.debugLineNum = 22;BA.debugLine="Activity.Title =ValoresComunes.GetLanStringDefaul";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstringdefault(mostCurrent.activityBA,"reg186","Functions")));
 //BA.debugLineNum = 24;BA.debugLine="Dim he As Int = 40dip";
_he = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40));
 //BA.debugLineNum = 26;BA.debugLine="ListView1.Height = Activity.Height - he";
...
mostCurrent._listview1.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 29;BA.debugLine="CmdGuardar.Top=Activity.Height-he";
mostCurrent._cmdguardar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 30;BA.debugLine="CmdGuardar.Left = Activity.Width   - (he+4dip)";
mostCurrent._cmdguardar.setLeft((int) (mostCurrent._activity.getWidth()-(_he+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4)))));
 //BA.debugLineNum = 31;BA.debugLine="CmdGuardar.Height =he";
mostCurrent._cmdguardar.setHeight(_he);
 //BA.debugLineNum = 32;BA.debugLine="CmdGuardar.Width =he' Activity.Width";
mostCurrent._cmdguardar.setWidth(_he);
 //BA.debugLineNum = 33;BA.debugLine="CmdGuardar.Text = \"\"'ValoresComunes.GetLanString";
mostCurrent._cmdguardar.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 34;BA.debugLine="CmdGuardar.SetBackgroundImage(ValoresComunes.CmdI";
mostCurrent._cmdguardar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgsave(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 36;BA.debugLine="CmdTerminar.Top=Activity.Height-he";
mostCurrent._cmdterminar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 37;BA.debugLine="CmdTerminar.Height =he";
mostCurrent._cmdterminar.setHeight(_he);
 //BA.debugLineNum = 38;BA.debugLine="CmdTerminar.Width =he";
mostCurrent._cmdterminar.setWidth(_he);
 //BA.debugLineNum = 39;BA.debugLine="CmdTerminar.Left =Activity.Width   - ((he  * 2)";
mostCurrent._cmdterminar.setLeft((int) (mostCurrent._activity.getWidth()-((_he*2)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8)))));
 //BA.debugLineNum = 40;BA.debugLine="CmdTerminar.SetBackgroundImage(ValoresComunes.Cmd";
mostCurrent._cmdterminar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgback(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 41;BA.debugLine="CmdTerminar.Text = \"\"";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="If ValoresComunes.CloseApp =True Then";
...
if (true) return "";
 ...
 //BA.debugLineNum = 51;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = True";
...
public static String  _cmdguardar_click() throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub CmdGuardar_Click";
 //BA.debugLineNum = 105;BA.debugLine="ValoresComunes.GuardaFunciones";
mostCurrent._valorescomunes._guardafunciones(mostCurrent.activityBA);
 //BA.debugLineNum = 106;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString (\"re";
...
public static String  _cmdterminar_click() throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Sub CmdTerminar_Click";
...
mostCurrent._listview1 = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private CmdTerminar As Button";
...
int _result = 0;
 //BA.debugLineNum = 64;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 65;BA.debugLine="Dim Lst As List";
_lst = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 66;BA.debugLine="Lst.Initialize";
_lst.Initialize();
 //BA.debugLineNum = 67;BA.debugLine="Lst.Add (ValoresComunes.GetLanString (\"reg111\"))";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg111")));
 //BA.debugLineNum = 68;BA.debugLine="Lst.Add(ValoresComunes.GetLanString (\"reg112\"))";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg112")));
 //BA.debugLineNum = 69;BA.debugLine="Lst.Add (ValoresComunes.GetLanStringDefault(\"DiT\"";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstringdefault(mostCurrent.activityBA,"DiT","Invisible element")));
 //BA.debugLineNum = 72;BA.debugLine="Dim Opcion As Int";
_opcion = 0;
 //BA.debugLineNum = 73;BA.debugLine="Opcion =InputList( Lst,ValoresComunes.GetLanStrin";
_opcion = anywheresoftware.b4a.keywords.Common.InputList(_lst,BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg75")),(int) (0),mostCurrent.activityBA);
 //BA.debugLineNum = 75;BA.debugLine="If Opcion =0 Then";
if (_opcion==0) { 
 //BA.debugLineNum = 76;BA.debugLine="Dim Dialog As InputDialog";
_dialog = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 78;BA.debugLine="Dialog.InputType =  Dialog.INPUT_TYPE_TEXT";
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 79;BA.debugLine="Dialog.Input = ValoresComunes.Functions  (Positi";
_dialog.setInput(mostCurrent._valorescomunes._functions[_position].Nombre);
 //BA.debugLineNum = 80;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 81;BA.debugLine="Result = Dialog.Show ( ValoresComunes.GetLanStri";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 83;BA.debugLine="ValoresComunes.Functions(Position).nombre =Dial";
mostCurrent._valorescomunes._functions[_position].Nombre = _dialog.getInput();
 };
 };
 //BA.debugLineNum = 86;BA.debugLine="If Opcion =1 Then";
if (_opcion==1) { 
 //BA.debugLineNum = 87;BA.debugLine="Dim Dialog As InputDialog";
_dialog = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 89;BA.debugLine="Dialog.InputType =  Dialog.INPUT_TYPE_TEXT";
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 90;BA.debugLine="Dialog.Input = ValoresComunes.Functions  (Positi";
_dialog.setInput(mostCurrent._valorescomunes._functions[_position].Descripcion);
 //BA.debugLineNum = 91;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 92;BA.debugLine="Result = Dialog.Show ( ValoresComunes.GetLanStri";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 94;BA.debugLine="ValoresComunes.Functions(Position).Descripcion";
mostCurrent._valorescomunes._functions[_position].Descripcion = _dialog.getInput();
 };
 };
 //BA.debugLineNum = 97;BA.debugLine="If Opcion =2 Then";
if (_opcion==2) { 
 //BA.debugLineNum = 99;BA.debugLine="ValoresComunes.Functions(Position).Descripcion";
mostCurrent._valorescomunes._functions[_position].Descripcion = "";
 //BA.debugLineNum = 100;BA.debugLine="ValoresComunes.Functions(Position).Nombre  =\"\"";
mostCurrent._valorescomunes._functions[_position].Nombre = "";
 };
 //BA.debugLineNum = 102;BA.debugLine="RefrescaPantalla";
_refrescapantalla();
...
arduino.automatizacion.excontrol.PRO.valorescomunes._scene _cmd = null;
 //BA.debugLineNum = 108;BA.debugLine="Sub RefrescaPantalla";
 //BA.debugLineNum = 109;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 110;BA.debugLine="Dim i As Int";
_i = 0;
 //BA.debugLineNum = 111;BA.debugLine="For i =0 To  ValoresComunes.Functions .Length -1";
{
final int step3 = 1;
final int limit3 = (int) (mostCurrent._valorescomunes._functions.length-1);
_i = (int) (0) ;
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((int)(0 + _i + step3))  ) {
 //BA.debugLineNum = 112;BA.debugLine="Dim cmd As Scene";
_cmd = new arduino.automatizacion.excontrol.PRO.valorescomunes._scene();
 //BA.debugLineNum = 113;BA.debugLine="cmd = ValoresComunes.Functions (i)";
_cmd = mostCurrent._valorescomunes._functions[_i];
 //BA.debugLineNum = 114;BA.debugLine="ListView1.AddTwoLinesAndBitmap2 ( cmd.Nombre ,cm";
