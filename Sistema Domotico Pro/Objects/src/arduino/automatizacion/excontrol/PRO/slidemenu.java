...
public class slidemenu extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "arduino.automatizacion.excontrol.PRO.slidemenu");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", arduino.automatizacion.excontrol.PRO.slidemenu.class).invoke(this, new Object[] {null});
        else
...
arduino.automatizacion.excontrol.PRO.slidemenu._actionitem _item = null;
...
_item = new arduino.automatizacion.excontrol.PRO.slidemenu._actionitem();
...
_mlistview = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private mInAnimation As Animation";
...
_mlistview.getTwoLinesAndBitmap().ImageView.SetLayout(__c.DipToCurrent((int) (13)),__c.DipToCurrent((int) (13)),__c.DipToCurrent((int) (24)),__c.DipToCurrent((int) (24)));
 //BA.debugLineNum = 42;BA.debugLine="mListView.Color=Colors.ARGB(255, 105, 105, 105)";
_mlistview.setColor(__c.Colors.ARGB((int) (255),(int) (105),(int) (105),(int) (105)));
