...
public class actconfigescenas extends Activity implements B4AActivity{
	public static actconfigescenas mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigescenas");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actconfigescenas).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigescenas");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "arduino.automatizacion.excontrol.PRO.actconfigescenas", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actconfigescenas) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actconfigescenas) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actconfigescenas) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (true) return "";};
 //BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout (\"frmconfig\")";
mostCurrent._activity.LoadLayout("frmconfig",mostCurrent.activityBA);
 //BA.debugLineNum = 24;BA.debugLine="Activity.Title =ValoresComunes.GetLanString (\"SS\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"SS")));
 //BA.debugLineNum = 28;BA.debugLine="Dim he As Int = 40dip";
_he = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40));
 //BA.debugLineNum = 30;BA.debugLine="ListView1.Height = Activity.Height - he  'PerYToC";
...
mostCurrent._listview1.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 33;BA.debugLine="CmdGuardar.Top=Activity.Height-he";
mostCurrent._cmdguardar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 34;BA.debugLine="CmdGuardar.Left = Activity.Width   - (he+4dip)";
mostCurrent._cmdguardar.setLeft((int) (mostCurrent._activity.getWidth()-(_he+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4)))));
 //BA.debugLineNum = 35;BA.debugLine="CmdGuardar.Height =he";
mostCurrent._cmdguardar.setHeight(_he);
 //BA.debugLineNum = 36;BA.debugLine="CmdGuardar.Width =he' Activity.Width";
mostCurrent._cmdguardar.setWidth(_he);
 //BA.debugLineNum = 37;BA.debugLine="CmdGuardar.Text = \"\"'ValoresComunes.GetLanString";
mostCurrent._cmdguardar.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 38;BA.debugLine="CmdGuardar.SetBackgroundImage(ValoresComunes.CmdI";
mostCurrent._cmdguardar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgsave(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 40;BA.debugLine="CmdTerminar.Top=Activity.Height-he";
mostCurrent._cmdterminar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 41;BA.debugLine="CmdTerminar.Height =he";
mostCurrent._cmdterminar.setHeight(_he);
 //BA.debugLineNum = 42;BA.debugLine="CmdTerminar.Width =he";
mostCurrent._cmdterminar.setWidth(_he);
 //BA.debugLineNum = 43;BA.debugLine="CmdTerminar.Left =Activity.Width   - ((he  * 2)";
mostCurrent._cmdterminar.setLeft((int) (mostCurrent._activity.getWidth()-((_he*2)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8)))));
 //BA.debugLineNum = 44;BA.debugLine="CmdTerminar.SetBackgroundImage(ValoresComunes.Cmd";
mostCurrent._cmdterminar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgback(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 45;BA.debugLine="CmdTerminar.Text = \"\"";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 49;BA.debugLine="If ValoresComunes.CloseApp =True Then";
...
if (true) return "";
 ...
 //BA.debugLineNum = 53;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = True";
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 54;BA.debugLine="RefrescaPantalla";
_refrescapantalla();
 }else {
...
public static String  _cmdguardar_click() throws Exception{
 //BA.debugLineNum = 114;BA.debugLine="Sub CmdGuardar_Click";
 //BA.debugLineNum = 115;BA.debugLine="ValoresComunes.GuardaEscenas";
mostCurrent._valorescomunes._guardaescenas(mostCurrent.activityBA);
 //BA.debugLineNum = 116;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString (\"re";
...
public static String  _cmdterminar_click() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub CmdTerminar_Click";
...
int _result = 0;
 //BA.debugLineNum = 67;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 68;BA.debugLine="Dim Lst As List";
_lst = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 69;BA.debugLine="Lst.Initialize";
_lst.Initialize();
 //BA.debugLineNum = 70;BA.debugLine="Lst.Add (ValoresComunes.GetLanString (\"reg111\"))";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg111")));
 //BA.debugLineNum = 71;BA.debugLine="Lst.Add(ValoresComunes.GetLanString (\"reg112\"))";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg112")));
 //BA.debugLineNum = 72;BA.debugLine="Lst.Add(ValoresComunes.GetLanString (\"SS\"))";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"SS")));
 //BA.debugLineNum = 73;BA.debugLine="Lst.Add(ValoresComunes.GetLanStringDefault (\"DiT\"";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstringdefault(mostCurrent.activityBA,"DiT","Invisible element")));
 //BA.debugLineNum = 75;BA.debugLine="Dim Opcion As Int";
_opcion = 0;
 //BA.debugLineNum = 76;BA.debugLine="Opcion =InputList( Lst,ValoresComunes.GetLanStrin";
_opcion = anywheresoftware.b4a.keywords.Common.InputList(_lst,BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg75")),(int) (0),mostCurrent.activityBA);
 //BA.debugLineNum = 78;BA.debugLine="If Opcion =0 Then";
if (_opcion==0) { 
 //BA.debugLineNum = 79;BA.debugLine="Dim Dialog As InputDialog";
_dialog = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 81;BA.debugLine="Dialog.InputType =  Dialog.INPUT_TYPE_TEXT";
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 82;BA.debugLine="Dialog.Input = ValoresComunes.Scenes  (Position)";
_dialog.setInput(mostCurrent._valorescomunes._scenes[_position].Nombre);
 //BA.debugLineNum = 83;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 84;BA.debugLine="Result = Dialog.Show ( ValoresComunes.GetLanStri";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 86;BA.debugLine="ValoresComunes.Scenes(Position).nombre =Dialog.";
mostCurrent._valorescomunes._scenes[_position].Nombre = _dialog.getInput();
 };
 };
 //BA.debugLineNum = 89;BA.debugLine="If Opcion =1 Then";
if (_opcion==1) { 
 //BA.debugLineNum = 90;BA.debugLine="Dim Dialog As InputDialog";
_dialog = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 92;BA.debugLine="Dialog.InputType =  Dialog.INPUT_TYPE_TEXT";
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 93;BA.debugLine="Dialog.Input = ValoresComunes.Scenes  (Position)";
_dialog.setInput(mostCurrent._valorescomunes._scenes[_position].Descripcion);
 //BA.debugLineNum = 94;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 95;BA.debugLine="Result = Dialog.Show ( ValoresComunes.GetLanStri";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 97;BA.debugLine="ValoresComunes.Scenes(Position).Descripcion  =D";
mostCurrent._valorescomunes._scenes[_position].Descripcion = _dialog.getInput();
 };
 };
 //BA.debugLineNum = 100;BA.debugLine="If Opcion =2 Then";
if (_opcion==2) { 
 //BA.debugLineNum = 102;BA.debugLine="ActConEscena.NumeroScene = Position +1";
mostCurrent._actconescena._numeroscene = (byte) (_position+1);
 //BA.debugLineNum = 103;BA.debugLine="StartActivity(ActConEscena)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actconescena.getObject()));
 //BA.debugLineNum = 105;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 108;BA.debugLine="If Opcion=3 Then";
if (_opcion==3) { 
 //BA.debugLineNum = 109;BA.debugLine="ValoresComunes.Scenes(Position).nombre =\"\"";
mostCurrent._valorescomunes._scenes[_position].Nombre = "";
 //BA.debugLineNum = 110;BA.debugLine="ValoresComunes.Scenes(Position).Descripcion  =\"\"";
mostCurrent._valorescomunes._scenes[_position].Descripcion = "";
 };
 //BA.debugLineNum = 112;BA.debugLine="RefrescaPantalla";
_refrescapantalla();
...
_c = 0;
 //BA.debugLineNum = 121;BA.debugLine="For c=0 To 9";
{
final int step3 = 1;
final int limit3 = (int) (9);
_c = (int) (0) ;
for (;(step3 > 0 && _c <= limit3) || (step3 < 0 && _c >= limit3) ;_c = ((int)(0 + _c + step3))  ) {
 //BA.debugLineNum = 123;BA.debugLine="ListView1.AddTwoLinesAndBitmap (ValoresComunes.S";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence(mostCurrent._valorescomunes._scenes[_c].Nombre),BA.ObjectToCharSequence(mostCurrent._valorescomunes._scenes[_c].Descripcion),(android.graphics.Bitmap)(mostCurrent._valorescomunes._scene2(mostCurrent.activityBA).getObject()));
 }
};
