...
public class actnotification extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actnotification");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actnotification");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "arduino.automatizacion.excontrol.PRO.actnotification", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
int _h = 0;
 ...
 //BA.debugLineNum = 34;BA.debugLine="Activity.LoadLayout(\"FrmBase\")";
mostCurrent._activity.LoadLayout("FrmBase",mostCurrent.activityBA);
 //BA.debugLineNum = 35;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = Fals";
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 40;BA.debugLine="ListView1.Initialize(\"ListView1\")";
...
_timer1.Initialize(processBA,"Timer1",(long) (100));
 //BA.debugLineNum = 57;BA.debugLine="Dim h As Int";
_h = 0;
 //BA.debugLineNum = 58;BA.debugLine="h=75dip";
_h = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (75));
 //BA.debugLineNum = 61;BA.debugLine="ListView1.TwoLinesAndBitmap .ItemHeight =h";
mostCurrent._listview1.getTwoLinesAndBitmap().setItemHeight(_h);
 //BA.debugLineNum = 62;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Width=h";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setWidth(_h);
 //BA.debugLineNum = 63;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.height=h";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setHeight(_h);
 //BA.debugLineNum = 65;BA.debugLine="ListView1.TwoLinesAndBitmap.Label .Left =h + h/9";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setLeft((int) (_h+_h/(double)9));
 //BA.debugLineNum = 66;BA.debugLine="ListView1.TwoLinesAndBitmap.Label.height  =h/1.8";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setHeight((int) (_h/(double)1.8));
 //BA.debugLineNum = 67;BA.debugLine="ListView1.TwoLinesAndBitmap.Label.Gravity = Bit.O";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.LEFT,anywheresoftware.b4a.keywords.Common.Gravity.BOTTOM));
 //BA.debugLineNum = 69;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel .Left =Li";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setLeft(mostCurrent._listview1.getTwoLinesAndBitmap().Label.getLeft());
 //BA.debugLineNum = 70;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.height";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setHeight((int) (_h-mostCurrent._listview1.getTwoLinesAndBitmap().Label.getHeight()));
 //BA.debugLineNum = 71;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.top   = L";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setTop(mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.getHeight());
 //BA.debugLineNum = 72;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.Gravity =";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.LEFT,anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 74;BA.debugLine="Activity.AddView (ListView1,0,52dip ,Activity.Wid";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._listview1.getObject()),(int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52)),mostCurrent._activity.getWidth(),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52))));
 //BA.debugLineNum = 76;BA.debugLine="sm.Initialize(Activity, Me,  \"SlideMenu\", 42dip,";
mostCurrent._sm._initialize(mostCurrent.activityBA,mostCurrent._activity,actnotification.getObject(),"SlideMenu",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (42)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (250)));
 //BA.debugLineNum = 77;BA.debugLine="ValoresComunes.BuldMenus (sm,4)";
mostCurrent._valorescomunes._buldmenus(mostCurrent.activityBA,mostCurrent._sm,(int) (4));
 //BA.debugLineNum = 79;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 393;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 395;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK And sm.isVisib";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK && mostCurrent._sm._isvisible()) { 
 //BA.debugLineNum = 396;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 397;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 401;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_MENU Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_MENU) { 
 //BA.debugLineNum = 402;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 142;BA.debugLine="UDPSocket1.Close";
_udpsocket1.Close();
...
if (true) return "";
 ...
 //BA.debugLineNum = 87;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = True";
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 88;BA.debugLine="If UDPSocket1.IsInitialized = False Then  Valore";
...
mostCurrent._valorescomunes._iniudp(mostCurrent.activityBA,_udpsocket1);};
 //BA.debugLineNum = 92;BA.debugLine="If ImgCargando.IsInitialized = False Then";
if (mostCurrent._imgcargando.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 93;BA.debugLine="ImgCargando.Initialize (\"ImgCargando\")";
mostCurrent._imgcargando.Initialize(mostCurrent.activityBA,"ImgCargando");
 //BA.debugLineNum = 94;BA.debugLine="ImgCargando.Bitmap = ValoresComunes.Cargando";
mostCurrent._imgcargando.setBitmap((android.graphics.Bitmap)(mostCurrent._valorescomunes._cargando(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 95;BA.debugLine="ImgCargando.Visible =False";
mostCurrent._imgcargando.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 96;BA.debugLine="ImgCargando.Gravity = Gravity.FILL";
mostCurrent._imgcargando.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 97;BA.debugLine="ImgCargando.Gravity = Gravity.FILL";
mostCurrent._imgcargando.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 98;BA.debugLine="Activity.AddView (ImgCargando,  PerXToCurrent(4";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._imgcargando.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (35),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA));
 ...
 //BA.debugLineNum = 100;BA.debugLine="AniCargando.InitializeRotateCenter( \"AniCargando";
mostCurrent._anicargando.InitializeRotateCenter(mostCurrent.activityBA,"AniCargando",(float) (0),(float) (180),(android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 101;BA.debugLine="AniCargando.Duration = 1000";
mostCurrent._anicargando.setDuration((long) (1000));
 //BA.debugLineNum = 102;BA.debugLine="AniCargando.RepeatCount =-1";
mostCurrent._anicargando.setRepeatCount((int) (-1));
 //BA.debugLineNum = 103;BA.debugLine="AniCargando.RepeatMode = AniCargando.REPEAT_R";
mostCurrent._anicargando.setRepeatMode(mostCurrent._anicargando.REPEAT_REVERSE);
 //BA.debugLineNum = 109;BA.debugLine="If Timer1.IsInitialized = False Then";
if (_timer1.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 110;BA.debugLine="Timer1.Initialize (\"Timer1\",100)";
_timer1.Initialize(processBA,"Timer1",(long) (100));
 }else {
 //BA.debugLineNum = 112;BA.debugLine="Timer1.Interval = 100";
_timer1.setInterval((long) (100));
 };
 //BA.debugLineNum = 114;BA.debugLine="If ValoresComunes.AlmName.IsInitialized =False T";
...
mostCurrent._valorescomunes._cargaalarmas(mostCurrent.activityBA);};
 //BA.debugLineNum = 117;BA.debugLine="ImgCargando.Visible =False";
mostCurrent._imgcargando.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 118;BA.debugLine="Timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 119;BA.debugLine="StartTimeOut";
_starttimeout();
 //BA.debugLineNum = 120;BA.debugLine="LecturaDatos";
_lecturadatos();
 }else {
...
int _i = 0;
 //BA.debugLineNum = 145;BA.debugLine="Sub ActualizaValores()";
 //BA.debugLineNum = 146;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 147;BA.debugLine="Dim i As Int";
_i = 0;
 //BA.debugLineNum = 148;BA.debugLine="For i =0 To 19";
{
final int step3 = 1;
final int limit3 = (int) (19);
_i = (int) (0) ;
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((int)(0 + _i + step3))  ) {
 //BA.debugLineNum = 149;BA.debugLine="If ValoresComunes.AlmName.Get (i)<>\"\" Then";
if ((mostCurrent._valorescomunes._almname.Get(_i)).equals((Object)("")) == false) { 
 //BA.debugLineNum = 150;BA.debugLine="Select Case Valores(i)";
switch (BA.switchObjectToInt(_valores[_i],(int) (1),(int) (2),(int) (3),(int) (4))) {
case 0: {
 //BA.debugLineNum = 152;BA.debugLine="ListView1.AddTwoLinesAndBitmap2 (ValoresComun";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence(mostCurrent._valorescomunes._almname.Get(_i)),BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg159")),(android.graphics.Bitmap)(mostCurrent._valorescomunes._almdes(mostCurrent.activityBA).getObject()),(Object)(_i));
 break; }
case 1: {
 //BA.debugLineNum = 154;BA.debugLine="ListView1.AddTwoLinesAndBitmap2 (ValoresComun";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence(mostCurrent._valorescomunes._almname.Get(_i)),BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg157")),(android.graphics.Bitmap)(mostCurrent._valorescomunes._almoff(mostCurrent.activityBA).getObject()),(Object)(_i));
 break; }
case 2: {
 //BA.debugLineNum = 157;BA.debugLine="ListView1.AddTwoLinesAndBitmap2 (ValoresComun";
...
public static String  _btnshow_click() throws Exception{
 //BA.debugLineNum = 406;BA.debugLine="Sub btnShow_Click";
 //BA.debugLineNum = 407;BA.debugLine="sm.Show";
mostCurrent._sm._show();
 //BA.debugLineNum = 408;BA.debugLine="End Sub";
return "";
}
public static String  _endtimeout() throws Exception{
 //BA.debugLineNum = 326;BA.debugLine="Sub EndTimeOut";
 //BA.debugLineNum = 327;BA.debugLine="ImgCargando.Visible =False";
mostCurrent._imgcargando.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 328;BA.debugLine="AniCargando.Stop  (ImgCargando)";
mostCurrent._anicargando.Stop((android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 329;BA.debugLine="ListView1.Enabled =True";
...
_conttim = 0;
 //BA.debugLineNum = 26;BA.debugLine="Dim Valores(20) As Int";
_valores = new int[(int) (20)];
;
 //BA.debugLineNum = 27;BA.debugLine="Private ImgCargando As ImageView";
mostCurrent._imgcargando = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Dim AniCargando As  Animation";
mostCurrent._anicargando = new anywheresoftware.b4a.objects.AnimationWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Dim UltimaTrama() As Byte";
...
byte[] _data = null;
String _trama = "";
 //BA.debugLineNum = 168;BA.debugLine="Sub LecturaDatos()";
 //BA.debugLineNum = 169;BA.debugLine="Dim data() As Byte";
_data = new byte[(int) (0)];
;
 //BA.debugLineNum = 170;BA.debugLine="Dim Trama As String";
_trama = "";
 //BA.debugLineNum = 171;BA.debugLine="If ValoresComunes.central.ConexionSegura Then";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
 //BA.debugLineNum = 172;BA.debugLine="Trama = \"ALRM\" & ValoresComunes.Central.Password";
_trama = "ALRM"+mostCurrent._valorescomunes._central.Password;
 }else {
 //BA.debugLineNum = 174;BA.debugLine="Trama = \"ALRM\"";
_trama = "ALRM";
 };
 //BA.debugLineNum = 177;BA.debugLine="data = Trama.GetBytes(\"UTF8\")";
_data = _trama.getBytes("UTF8");
 //BA.debugLineNum = 179;BA.debugLine="SendTrama(data)";
_sendtrama(_data);
...
int _longtrama = 0;
byte[] _data = null;
 //BA.debugLineNum = 278;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 279;BA.debugLine="Dim l As List";
_l = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 280;BA.debugLine="l.Initialize";
_l.Initialize();
 //BA.debugLineNum = 281;BA.debugLine="l.Add (ValoresComunes.GetLanString (\"reg160\"))";
_l.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg160")));
 //BA.debugLineNum = 282;BA.debugLine="l.Add (ValoresComunes.GetLanString (\"reg161\"))";
_l.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg161")));
 //BA.debugLineNum = 289;BA.debugLine="Dim v As Int";
_v = 0;
 //BA.debugLineNum = 290;BA.debugLine="v =InputList(l,ValoresComunes.GetLanString (\"reg7";
_v = anywheresoftware.b4a.keywords.Common.InputList(_l,BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg75")),_valores[(int)(BA.ObjectToNumber(_value))],mostCurrent.activityBA);
 //BA.debugLineNum = 291;BA.debugLine="If v<0 Then Return";
if (_v<0) { 
if (true) return "";};
 //BA.debugLineNum = 292;BA.debugLine="Dim LongTrama As Int";
_longtrama = 0;
 //BA.debugLineNum = 293;BA.debugLine="If ValoresComunes.central.ConexionSegura Then";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
 //BA.debugLineNum = 294;BA.debugLine="LongTrama= 17";
_longtrama = (int) (17);
 }else {
 //BA.debugLineNum = 296;BA.debugLine="LongTrama= 9";
_longtrama = (int) (9);
 };
 //BA.debugLineNum = 299;BA.debugLine="Dim data(LongTrama) As Byte";
_data = new byte[_longtrama];
;
 //BA.debugLineNum = 300;BA.debugLine="data(0)=83";
_data[(int) (0)] = (byte) (83);
 //BA.debugLineNum = 301;BA.debugLine="data(1)=69";
_data[(int) (1)] = (byte) (69);
 //BA.debugLineNum = 302;BA.debugLine="data(2)=84";
_data[(int) (2)] = (byte) (84);
 //BA.debugLineNum = 303;BA.debugLine="data(3)=78";
_data[(int) (3)] = (byte) (78);
 //BA.debugLineNum = 304;BA.debugLine="data(4)=79";
_data[(int) (4)] = (byte) (79);
 //BA.debugLineNum = 305;BA.debugLine="data(5)=84";
_data[(int) (5)] = (byte) (84);
 //BA.debugLineNum = 306;BA.debugLine="data(6)=73";
_data[(int) (6)] = (byte) (73);
 //BA.debugLineNum = 308;BA.debugLine="data(7)= Value +1";
_data[(int) (7)] = (byte) ((double)(BA.ObjectToNumber(_value))+1);
 //BA.debugLineNum = 309;BA.debugLine="If v=0 Then";
if (_v==0) { 
 //BA.debugLineNum = 310;BA.debugLine="Valores(Value)=2";
_valores[(int)(BA.ObjectToNumber(_value))] = (int) (2);
 //BA.debugLineNum = 311;BA.debugLine="data(8)= 2";
_data[(int) (8)] = (byte) (2);
 }else {
 //BA.debugLineNum = 313;BA.debugLine="Valores(Value)=1";
_valores[(int)(BA.ObjectToNumber(_value))] = (int) (1);
 //BA.debugLineNum = 314;BA.debugLine="data(8)= 1";
_data[(int) (8)] = (byte) (1);
 };
 //BA.debugLineNum = 316;BA.debugLine="StartTimeOut";
_starttimeout();
 //BA.debugLineNum = 317;BA.debugLine="If ValoresComunes.central.ConexionSegura Then Va";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
...
anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket _packet = null;
 //BA.debugLineNum = 265;BA.debugLine="Sub SendingTrama (data() As Byte) As Boolean";
 //BA.debugLineNum = 266;BA.debugLine="Try";
try { //BA.debugLineNum = 267;BA.debugLine="Dim Packet As UDPPacket";
_packet = new anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket();
 //BA.debugLineNum = 269;BA.debugLine="Packet.Initialize(data, ValoresComunes.ip,  Valo";
_packet.Initialize(_data,mostCurrent._valorescomunes._ip,mostCurrent._valorescomunes._puerto);
 //BA.debugLineNum = 270;BA.debugLine="UDPSocket1.Send(Packet)";
_udpsocket1.Send(_packet);
 //BA.debugLineNum = 271;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e7) {
			processBA.setLastException(e7); //BA.debugLineNum = 273;BA.debugLine="Return False";
...
public ResumableSub_SendTrama(arduino.automatizacion.excontrol.PRO.actnotification parent,byte[] _data) {
this.parent = parent;
this._data = _data;
}
arduino.automatizacion.excontrol.PRO.actnotification parent;
byte[] _data;
...
_reintento = 0;
 //BA.debugLineNum = 219;BA.debugLine="UltimaTrama=data";
...
_reintento = (int) (_reintento+1);
 //BA.debugLineNum = 238;BA.debugLine="Sleep (100)";
...
public static String  _slidemenu_click(Object _item) throws Exception{
 //BA.debugLineNum = 332;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 333;BA.debugLine="If Item>99 And  Item < 200 Then";
if ((double)(BA.ObjectToNumber(_item))>99 && (double)(BA.ObjectToNumber(_item))<200) { 
 //BA.debugLineNum = 334;BA.debugLine="ActMosaico.Conectado =False";
mostCurrent._actmosaico._conectado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 335;BA.debugLine="ActMosaico.CentraltoConnect  =Item-100";
mostCurrent._actmosaico._centraltoconnect = (int) ((double)(BA.ObjectToNumber(_item))-100);
 //BA.debugLineNum = 336;BA.debugLine="StartActivity(ActMosaico)";
...
mostCurrent._activity.Finish();
 ...
 //BA.debugLineNum = 345;BA.debugLine="Select Case Item";
...
case 0: {
 //BA.debugLineNum = 348;BA.debugLine="StartActivity(ActMosaico)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actmosaico.getObject()));
 //BA.debugLineNum = 349;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 break; }
case 1: {
 //BA.debugLineNum = 351;BA.debugLine="StartActivity(ActCircuit)";
...
mostCurrent._activity.Finish();
 break; }
case 2: {
 //BA.debugLineNum = 354;BA.debugLine="StartActivity(ActScene)";
...
case 3: {
 break; }
case 4: {
 //BA.debugLineNum = 360;BA.debugLine="StartActivity(ActCondicionados)";
...
mostCurrent._activity.Finish();
 break; }
case 5: {
 //BA.debugLineNum = 363;BA.debugLine="StartActivity(ActComandos)";
...
mostCurrent._activity.Finish();
 break; }
case 6: {
 //BA.debugLineNum = 366;BA.debugLine="StartActivity(ActSensors)";
...
mostCurrent._activity.Finish();
 break; }
case 7: {
 //BA.debugLineNum = 369;BA.debugLine="If File.Exists ( File.DirInternal ,\"Sensores\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"Sensores"+mostCurrent._valorescomunes._central.Nombre)) { 
 //BA.debugLineNum = 370;BA.debugLine="StartActivity(ActFreeTxt)";
...
mostCurrent._activity.Finish();
 ...
 //BA.debugLineNum = 373;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg127")),anywheresoftware.b4a.keywords.Common.True);
 ...
 break; }
case 8: {
 //BA.debugLineNum = 376;BA.debugLine="StartActivity(ActConsignas)";
...
mostCurrent._activity.Finish();
 break; }
case 9: {
 //BA.debugLineNum = 379;BA.debugLine="ValoresComunes.CloseApp =True";
...
mostCurrent._activity.Finish();
 break; }
case 10: {
 //BA.debugLineNum = 382;BA.debugLine="StartActivity(ActFunciones)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actfunciones.getObject()));
 //BA.debugLineNum = 383;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 break; }
case 11: {
 //BA.debugLineNum = 386;BA.debugLine="StartActivity(ActSelectSensores)";
...
public static String  _starttimeout() throws Exception{
 //BA.debugLineNum = 321;BA.debugLine="Sub StartTimeOut";
 //BA.debugLineNum = 322;BA.debugLine="ImgCargando.Visible =True";
mostCurrent._imgcargando.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 323;BA.debugLine="AniCargando.Start (ImgCargando)";
mostCurrent._anicargando.Start((android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 324;BA.debugLine="ListView1.Enabled =False";
mostCurrent._listview1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 325;BA.debugLine="End Sub";
return "";
}
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Sub Timer1_Tick";
 //BA.debugLineNum = 130;BA.debugLine="ContTim=ContTim+1";
_conttim = (int) (_conttim+1);
 //BA.debugLineNum = 131;BA.debugLine="If  ContTim >50 Then";
if (_conttim>50) { 
 //BA.debugLineNum = 132;BA.debugLine="If ImgCargando.Visible Then";
if (mostCurrent._imgcargando.getVisible()) { 
 //BA.debugLineNum = 133;BA.debugLine="SendTrama(UltimaTrama)";
_sendtrama(_ultimatrama);
 }else {
 //BA.debugLineNum = 135;BA.debugLine="LecturaDatos";
_lecturadatos();
 };
 };
...
String _msg = "";
int _c = 0;
 //BA.debugLineNum = 182;BA.debugLine="Sub UDP_PacketArrived (Packet As UDPPacket)";
 //BA.debugLineNum = 183;BA.debugLine="Try";
try { //BA.debugLineNum = 184;BA.debugLine="Dim msg As String";
_msg = "";
 //BA.debugLineNum = 185;BA.debugLine="msg = BytesToString(Packet.Data, Packet.Offse";
_msg = anywheresoftware.b4a.keywords.Common.BytesToString(_packet.getData(),_packet.getOffset(),_packet.getLength(),"UTF8");
 //BA.debugLineNum = 187;BA.debugLine="If msg.Contains (\"ESAL\") Then";
if (_msg.contains("ESAL")) { 
 //BA.debugLineNum = 189;BA.debugLine="Dim  C As Int";
_c = 0;
 //BA.debugLineNum = 190;BA.debugLine="For C = 4 To Packet.Length -1";
{
final int step6 = 1;
final int limit6 = (int) (_packet.getLength()-1);
_c = (int) (4) ;
for (;(step6 > 0 && _c <= limit6) || (step6 < 0 && _c >= limit6) ;_c = ((int)(0 + _c + step6))  ) {
 //BA.debugLineNum = 191;BA.debugLine="Valores(C - 4)= Packet.Data (C)";
...
_actualizavalores();
 ...
 //BA.debugLineNum = 198;BA.debugLine="If msg=\"WIALMO\" Then";
if ((_msg).equals("WIALMO")) { 
 //BA.debugLineNum = 200;BA.debugLine="ActualizaValores";
_actualizavalores();
 //BA.debugLineNum = 201;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString (\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg139")),anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 203;BA.debugLine="If msg= \"COMPLETED\" Then";
if ((_msg).equals("COMPLETED")) { 
 //BA.debugLineNum = 204;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString (\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg139")),anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 206;BA.debugLine="If msg =\"REPETIRMSG\" Then";
if ((_msg).equals("REPETIRMSG")) { 
 //BA.debugLineNum = 207;BA.debugLine="LecturaDatos";
_lecturadatos();
 };
 //BA.debugLineNum = 210;BA.debugLine="If ImgCargando.Visible Then EndTimeOut";
if (mostCurrent._imgcargando.getVisible()) { 
_endtimeout();};
 } 
       catch (Exception e23) {
