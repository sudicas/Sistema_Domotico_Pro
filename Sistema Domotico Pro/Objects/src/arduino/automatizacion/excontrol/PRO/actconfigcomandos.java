...
public class actconfigcomandos extends Activity implements B4AActivity{
	public static actconfigcomandos mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigcomandos");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actconfigcomandos).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigcomandos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "arduino.automatizacion.excontrol.PRO.actconfigcomandos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actconfigcomandos) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actconfigcomandos) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return actconfigcomandos.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actconfigcomandos) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("FrmConfig2",mostCurrent.activityBA);
 //BA.debugLineNum = 24;BA.debugLine="Activity.Title =ValoresComunes.GetLanString (\"SCO";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"SCO")));
...
if (true) return "";
 ...
 //BA.debugLineNum = 61;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = Tru";
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 62;BA.debugLine="RefrescaPantalla";
_refrescapantalla();
 }else {
...
public static String  _cmdguardar_click() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub CmdGuardar_Click";
 //BA.debugLineNum = 129;BA.debugLine="ValoresComunes.GuardaComandos";
mostCurrent._valorescomunes._guardacomandos(mostCurrent.activityBA);
 //BA.debugLineNum = 130;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString (\"re";
...
int _result = 0;
 ...
 //BA.debugLineNum = 134;BA.debugLine="Dim cmd As Scene";
_cmd = new arduino.automatizacion.excontrol.PRO.valorescomunes._scene();
 //BA.debugLineNum = 136;BA.debugLine="Dim Dial As InputDialog";
_dial = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 137;BA.debugLine="Dial.InputType =  Dial.INPUT_TYPE_TEXT";
_dial.setInputType(_dial.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 138;BA.debugLine="Dial.Input =\"\"";
_dial.setInput("");
 //BA.debugLineNum = 139;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 141;BA.debugLine="Result = Dial.Show ( ValoresComunes.GetLanString";
...
if (true) return "";
 ...
 //BA.debugLineNum = 145;BA.debugLine="cmd.Nombre  = Dial.Input";
_cmd.Nombre = _dial.getInput();
 };
 //BA.debugLineNum = 147;BA.debugLine="Dial.Input =\"\"";
_dial.setInput("");
 //BA.debugLineNum = 148;BA.debugLine="Result = Dial.Show ( ValoresComunes.GetLanString";
...
if (true) return "";
 ...
 //BA.debugLineNum = 152;BA.debugLine="cmd.Descripcion  = Dial.Input";
_cmd.Descripcion = _dial.getInput();
 };
 //BA.debugLineNum = 156;BA.debugLine="ValoresComunes.Comandos .Add (cmd)";
mostCurrent._valorescomunes._comandos.Add((Object)(_cmd));
 //BA.debugLineNum = 157;BA.debugLine="ValoresComunes.GuardaComandos";
mostCurrent._valorescomunes._guardacomandos(mostCurrent.activityBA);
 //BA.debugLineNum = 158;BA.debugLine="RefrescaPantalla";
_refrescapantalla();
 //BA.debugLineNum = 159;BA.debugLine="End Sub";
return "";
}
public static String  _cmdterminar_click() throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Sub CmdTerminar_Click";
...
int _result = 0;
 //BA.debugLineNum = 78;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 79;BA.debugLine="Dim Lst As List";
_lst = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 80;BA.debugLine="Lst.Initialize";
_lst.Initialize();
 //BA.debugLineNum = 81;BA.debugLine="Lst.Add (ValoresComunes.GetLanString (\"reg111\"))";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg111")));
 //BA.debugLineNum = 82;BA.debugLine="Lst.Add(ValoresComunes.GetLanString (\"reg112\"))";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg112")));
 //BA.debugLineNum = 85;BA.debugLine="Dim Opcion As Int";
_opcion = 0;
 //BA.debugLineNum = 86;BA.debugLine="Opcion =InputList( Lst,ValoresComunes.GetLanStrin";
_opcion = anywheresoftware.b4a.keywords.Common.InputList(_lst,BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg75")),(int) (0),mostCurrent.activityBA);
 //BA.debugLineNum = 87;BA.debugLine="Dim cmd As Scene";
_cmd = new arduino.automatizacion.excontrol.PRO.valorescomunes._scene();
 //BA.debugLineNum = 88;BA.debugLine="cmd = ValoresComunes.Comandos.Get (Position)";
_cmd = (arduino.automatizacion.excontrol.PRO.valorescomunes._scene)(mostCurrent._valorescomunes._comandos.Get(_position));
 //BA.debugLineNum = 89;BA.debugLine="If Opcion =0 Then";
if (_opcion==0) { 
...
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 93;BA.debugLine="Dialog.Input = cmd.Nombre";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 97;BA.debugLine="cmd.nombre =Dialog.Input";
_cmd.Nombre = _dialog.getInput();
 };
 };
 //BA.debugLineNum = 100;BA.debugLine="If Opcion =1 Then";
if (_opcion==1) { 
 //BA.debugLineNum = 101;BA.debugLine="Dim Dialog As InputDialog";
_dialog = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 103;BA.debugLine="Dialog.InputType =  Dialog.INPUT_TYPE_TEXT";
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 104;BA.debugLine="Dialog.Input = cmd.Descripcion";
_dialog.setInput(_cmd.Descripcion);
 //BA.debugLineNum = 105;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 106;BA.debugLine="Result = Dialog.Show ( ValoresComunes.GetLanStri";
_result = _dialog.Show(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg90"),mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg112"),mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg83"),mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"Cancel"),"",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 107;BA.debugLine="If Result=  DialogResponse.POSITIVE  Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 108;BA.debugLine="cmd.Descripcion  =Dialog.Input";
...
int _c = 0;
arduino.automatizacion.excontrol.PRO.valorescomunes._scene _cmd = null;
 //BA.debugLineNum = 115;BA.debugLine="Sub RefrescaPantalla";
 //BA.debugLineNum = 116;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 117;BA.debugLine="Dim c As Int";
_c = 0;
 //BA.debugLineNum = 120;BA.debugLine="For c=0 To ValoresComunes.Comandos.Size -1";
{
final int step3 = 1;
...
for (;(step3 > 0 && _c <= limit3) || (step3 < 0 && _c >= limit3) ;_c = ((int)(0 + _c + step3))  ) {
 //BA.debugLineNum = 121;BA.debugLine="Dim cmd As Scene";
_cmd = new arduino.automatizacion.excontrol.PRO.valorescomunes._scene();
 //BA.debugLineNum = 122;BA.debugLine="cmd = ValoresComunes.Comandos.Get (c)";
_cmd = (arduino.automatizacion.excontrol.PRO.valorescomunes._scene)(mostCurrent._valorescomunes._comandos.Get(_c));
 //BA.debugLineNum = 123;BA.debugLine="ListView1.AddTwoLinesAndBitmap  (cmd.Nombre ,cmd";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence(_cmd.Nombre),BA.ObjectToCharSequence(_cmd.Descripcion),(android.graphics.Bitmap)(mostCurrent._valorescomunes._comando(mostCurrent.activityBA).getObject()));
 }
};
