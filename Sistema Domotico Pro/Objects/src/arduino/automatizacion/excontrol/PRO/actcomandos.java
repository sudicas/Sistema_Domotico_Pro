...
public class actcomandos extends Activity implements B4AActivity{
	public static actcomandos mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actcomandos");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actcomandos).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actcomandos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "arduino.automatizacion.excontrol.PRO.actcomandos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actcomandos) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actcomandos) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actcomandos) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public anywheresoftware.b4a.objects.ButtonWrapper _cmdselect = null;
...
if (_firsttime) { 
 ...
 //BA.debugLineNum = 36;BA.debugLine="Activity.LoadLayout (\"FrmComandos\")";
mostCurrent._activity.LoadLayout("FrmComandos",mostCurrent.activityBA);
 //BA.debugLineNum = 40;BA.debugLine="ListView1.height = PerYToCurrent(85) -52dip";
mostCurrent._listview1.setHeight((int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (85),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52))));
...
mostCurrent._listview1.setTop(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52)));
 //BA.debugLineNum = 53;BA.debugLine="CmdSelect.Top=PerYToCurrent(85)";
mostCurrent._cmdselect.setTop(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (85),mostCurrent.activityBA));
 //BA.debugLineNum = 54;BA.debugLine="CmdSelect.height =PerYToCurrent(15)";
mostCurrent._cmdselect.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (15),mostCurrent.activityBA));
 //BA.debugLineNum = 55;BA.debugLine="CmdSelect.Width = Activity.Width";
mostCurrent._cmdselect.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 60;BA.debugLine="Dim h As Int";
_h = 0;
 //BA.debugLineNum = 61;BA.debugLine="h=75dip";
_h = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (75));
 //BA.debugLineNum = 64;BA.debugLine="ListView1.TwoLinesAndBitmap .ItemHeight =h";
mostCurrent._listview1.getTwoLinesAndBitmap().setItemHeight(_h);
 //BA.debugLineNum = 65;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Width=h";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setWidth(_h);
 //BA.debugLineNum = 66;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.height=h";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setHeight(_h);
 //BA.debugLineNum = 68;BA.debugLine="ListView1.TwoLinesAndBitmap.Label .Left =h + h/9";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setLeft((int) (_h+_h/(double)9));
 //BA.debugLineNum = 69;BA.debugLine="ListView1.TwoLinesAndBitmap.Label.height  =h/1.8";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setHeight((int) (_h/(double)1.8));
 //BA.debugLineNum = 70;BA.debugLine="ListView1.TwoLinesAndBitmap.Label.Gravity = Bit.O";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.LEFT,anywheresoftware.b4a.keywords.Common.Gravity.BOTTOM));
 //BA.debugLineNum = 72;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel .Left =Li";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setLeft(mostCurrent._listview1.getTwoLinesAndBitmap().Label.getLeft());
 //BA.debugLineNum = 73;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.height";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setHeight((int) (_h-mostCurrent._listview1.getTwoLinesAndBitmap().Label.getHeight()));
 //BA.debugLineNum = 74;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.top   = L";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setTop(mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.getHeight());
 //BA.debugLineNum = 75;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.Gravity =";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.LEFT,anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 78;BA.debugLine="sm.Initialize(Activity, Me,  \"SlideMenu\", 42dip,";
mostCurrent._sm._initialize(mostCurrent.activityBA,mostCurrent._activity,actcomandos.getObject(),"SlideMenu",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (42)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (250)));
 //BA.debugLineNum = 79;BA.debugLine="ValoresComunes.BuldMenus (sm,6)";
mostCurrent._valorescomunes._buldmenus(mostCurrent.activityBA,mostCurrent._sm,(int) (6));
 //BA.debugLineNum = 82;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 327;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 329;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK And sm.isVisib";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK && mostCurrent._sm._isvisible()) { 
 //BA.debugLineNum = 330;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 331;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 335;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_MENU Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_MENU) { 
 //BA.debugLineNum = 336;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 85;BA.debugLine="UDPSocket1.Close";
_udpsocket1.Close();
...
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 97;BA.debugLine="CmdSelect.Text= ValoresComunes.descripcionesComa";
mostCurrent._cmdselect.setText(BA.ObjectToCharSequence(mostCurrent._valorescomunes._descripcionescomandos.Get((int) (0))));
...
mostCurrent._valorescomunes._iniudp(mostCurrent.activityBA,_udpsocket1);};
 //BA.debugLineNum = 106;BA.debugLine="Activity.Title =ValoresComunes.GetLanString (\"re";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg132")));
 //BA.debugLineNum = 108;BA.debugLine="If ImgCargando.IsInitialized = False Then";
if (mostCurrent._imgcargando.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 109;BA.debugLine="ImgCargando.Initialize (\"ImgCargando\")";
mostCurrent._imgcargando.Initialize(mostCurrent.activityBA,"ImgCargando");
 //BA.debugLineNum = 110;BA.debugLine="ImgCargando.Bitmap = ValoresComunes.Cargando";
mostCurrent._imgcargando.setBitmap((android.graphics.Bitmap)(mostCurrent._valorescomunes._cargando(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 111;BA.debugLine="ImgCargando.Visible =False";
mostCurrent._imgcargando.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 112;BA.debugLine="ImgCargando.Gravity = Gravity.FILL";
mostCurrent._imgcargando.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 113;BA.debugLine="Activity.AddView (ImgCargando,  PerXToCurrent(4";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._imgcargando.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (35),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA));
 ...
 //BA.debugLineNum = 115;BA.debugLine="RefPantalla";
_refpantalla();
 //BA.debugLineNum = 116;BA.debugLine="AniCargando.InitializeRotateCenter( \"AniCargando";
mostCurrent._anicargando.InitializeRotateCenter(mostCurrent.activityBA,"AniCargando",(float) (0),(float) (180),(android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 117;BA.debugLine="AniCargando.Duration  =   1000";
mostCurrent._anicargando.setDuration((long) (1000));
 //BA.debugLineNum = 118;BA.debugLine="AniCargando.RepeatCount =5";
mostCurrent._anicargando.setRepeatCount((int) (5));
 //BA.debugLineNum = 119;BA.debugLine="AniCargando.RepeatMode = AniCargando.REPEAT_R";
...
public static String  _anicargando_animationend() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub AniCargando_AnimationEnd";
 //BA.debugLineNum = 130;BA.debugLine="If PaqueteEnviado = True Then";
if (_paqueteenviado==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="AniCargando.Start (ImgCargando)";
mostCurrent._anicargando.Start((android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 132;BA.debugLine="SendTrama(TramaEnviada)";
...
public static String  _btnshow_click() throws Exception{
 //BA.debugLineNum = 340;BA.debugLine="Sub btnShow_Click";
 //BA.debugLineNum = 341;BA.debugLine="sm.Show";
mostCurrent._sm._show();
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return "";
}
public static String  _cmdselect_click() throws Exception{
int _pos = 0;
 //BA.debugLineNum = 257;BA.debugLine="Sub CmdSelect_Click";
 //BA.debugLineNum = 258;BA.debugLine="Dim Pos As Int";
_pos = 0;
 //BA.debugLineNum = 260;BA.debugLine="Pos =InputList(ValoresComunes.descripcionesComand";
_pos = anywheresoftware.b4a.keywords.Common.InputList(mostCurrent._valorescomunes._descripcionescomandos,BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg75")),_pos,mostCurrent.activityBA);
 //BA.debugLineNum = 261;BA.debugLine="If Pos>=0 Then";
if (_pos>=0) { 
 //BA.debugLineNum = 262;BA.debugLine="CmdSelect.Text  = ValoresComunes.descripcionesCo";
mostCurrent._cmdselect.setText(BA.ObjectToCharSequence(mostCurrent._valorescomunes._descripcionescomandos.Get(_pos)));
 //BA.debugLineNum = 263;BA.debugLine="RefPantalla";
_refpantalla();
 };
...
_paqueteenviado = false;
 //BA.debugLineNum = 24;BA.debugLine="Dim CmdSelect As Button";
mostCurrent._cmdselect = new anywheresoftware.b4a.objects.ButtonWrapper();
...
int _longtrama = 0;
byte[] _data = null;
 //BA.debugLineNum = 149;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 152;BA.debugLine="Dim LongTrama As Int";
_longtrama = 0;
 //BA.debugLineNum = 153;BA.debugLine="If ValoresComunes.central.ConexionSegura Then";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
 //BA.debugLineNum = 154;BA.debugLine="LongTrama= 16";
_longtrama = (int) (16);
 }else {
 //BA.debugLineNum = 156;BA.debugLine="LongTrama= 8";
_longtrama = (int) (8);
 };
 //BA.debugLineNum = 158;BA.debugLine="Dim data(LongTrama) As Byte";
_data = new byte[_longtrama];
;
 //BA.debugLineNum = 159;BA.debugLine="data(0)=67	'C";
_data[(int) (0)] = (byte) (67);
 //BA.debugLineNum = 160;BA.debugLine="data(1)=79	'O";
_data[(int) (1)] = (byte) (79);
 //BA.debugLineNum = 161;BA.debugLine="data(2)=77	'M";
_data[(int) (2)] = (byte) (77);
 //BA.debugLineNum = 162;BA.debugLine="data(3)=65	'A";
_data[(int) (3)] = (byte) (65);
 //BA.debugLineNum = 163;BA.debugLine="data(4)=78	'N";
_data[(int) (4)] = (byte) (78);
 //BA.debugLineNum = 164;BA.debugLine="data(5)=68	'D";
_data[(int) (5)] = (byte) (68);
 //BA.debugLineNum = 165;BA.debugLine="data(6)=79	'O";
_data[(int) (6)] = (byte) (79);
 //BA.debugLineNum = 166;BA.debugLine="data(7)=Value + 1";
_data[(int) (7)] = (byte) ((double)(BA.ObjectToNumber(_value))+1);
 //BA.debugLineNum = 167;BA.debugLine="If ValoresComunes.central.ConexionSegura Then Val";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
...
arduino.automatizacion.excontrol.PRO.valorescomunes._scene _cmd = null;
 //BA.debugLineNum = 135;BA.debugLine="Sub RefPantalla";
 //BA.debugLineNum = 136;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 137;BA.debugLine="Dim i As Int";
_i = 0;
 //BA.debugLineNum = 138;BA.debugLine="For i =0 To  ValoresComunes.Comandos.Size -1";
{
final int step3 = 1;
final int limit3 = (int) (mostCurrent._valorescomunes._comandos.getSize()-1);
_i = (int) (0) ;
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((int)(0 + _i + step3))  ) {
 //BA.debugLineNum = 139;BA.debugLine="Dim cmd As Scene";
_cmd = new arduino.automatizacion.excontrol.PRO.valorescomunes._scene();
 //BA.debugLineNum = 140;BA.debugLine="cmd = ValoresComunes.Comandos.Get (i)";
_cmd = (arduino.automatizacion.excontrol.PRO.valorescomunes._scene)(mostCurrent._valorescomunes._comandos.Get(_i));
 //BA.debugLineNum = 141;BA.debugLine="If cmd.Nombre <> \"\" And cmd.Descripcion = CmdSel";
if ((_cmd.Nombre).equals("") == false && (_cmd.Descripcion).equals(mostCurrent._cmdselect.getText())) { 
 //BA.debugLineNum = 142;BA.debugLine="ListView1.AddTwoLinesAndBitmap2 ( cmd.Nombre ,c";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence(_cmd.Nombre),BA.ObjectToCharSequence(_cmd.Descripcion),(android.graphics.Bitmap)(mostCurrent._valorescomunes._comando(mostCurrent.activityBA).getObject()),(Object)(_i));
 };
 }
};
...
_packet = new anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket();
 //BA.debugLineNum = 245;BA.debugLine="Packet.Initialize(data, ValoresComunes.ip, Valor";
_packet.Initialize(_data,mostCurrent._valorescomunes._ip,mostCurrent._valorescomunes._puerto);
 //BA.debugLineNum = 246;BA.debugLine="UDPSocket1.Send(Packet)";
_udpsocket1.Send(_packet);
 //BA.debugLineNum = 247;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e7) {
			processBA.setLastException(e7); //BA.debugLineNum = 249;BA.debugLine="Return False";
...
public ResumableSub_SendTrama(arduino.automatizacion.excontrol.PRO.actcomandos parent,byte[] _data) {
this.parent = parent;
this._data = _data;
}
arduino.automatizacion.excontrol.PRO.actcomandos parent;
byte[] _data;
...
//C
this.state = 1;
 //BA.debugLineNum = 198;BA.debugLine="Dim Resultado As Boolean";
_resultado = false;
 //BA.debugLineNum = 199;BA.debugLine="Dim Reintento As Int";
_reintento = 0;
 //BA.debugLineNum = 201;BA.debugLine="ImgCargando.Visible =True";
parent.mostCurrent._imgcargando.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 202;BA.debugLine="AniCargando.Start (ImgCargando)";
parent.mostCurrent._anicargando.Start((android.view.View)(parent.mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 204;BA.debugLine="PaqueteEnviado =False";
parent._paqueteenviado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 205;BA.debugLine="TramaEnviada= data";
parent._tramaenviada = _data;
 //BA.debugLineNum = 207;BA.debugLine="Do 	While Resultado= False And Reintento < 40";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 208;BA.debugLine="Dim ServerSocket1 As ServerSocket";
_serversocket1 = new anywheresoftware.b4a.objects.SocketWrapper.ServerSocketWrapper();
 //BA.debugLineNum = 209;BA.debugLine="Dim MyIp As String";
_myip = "";
 //BA.debugLineNum = 210;BA.debugLine="If ActMosaico.Forzar3g Then";
if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 211;BA.debugLine="MyIp=ServerSocket1.GetMyIP";
...
//C
this.state = 9;
 //BA.debugLineNum = 213;BA.debugLine="MyIp=ServerSocket1.GetMyWifiIP";
_myip = _serversocket1.GetMyWifiIP();
 if (true) break;
;
 //BA.debugLineNum = 215;BA.debugLine="If MyIp  <> \"127.0.0.1\" Then";
...
//C
this.state = 14;
 //BA.debugLineNum = 216;BA.debugLine="Resultado = True";
...
_reintento = (int) (_reintento+1);
 //BA.debugLineNum = 219;BA.debugLine="Sleep (200)";
...
;
 if (true) break;
;
 //BA.debugLineNum = 223;BA.debugLine="If Resultado = True Then";
...
//C
this.state = 18;
 //BA.debugLineNum = 224;BA.debugLine="Resultado =False";
_resultado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 225;BA.debugLine="Reintento =0";
_reintento = (int) (0);
 //BA.debugLineNum = 226;BA.debugLine="Do 	While Resultado= False And Reintento < 40";
if (true) break;
...
//C
this.state = 21;
 //BA.debugLineNum = 227;BA.debugLine="Resultado = SendingTrama(data)";
_resultado = _sendingtrama(_data);
 //BA.debugLineNum = 228;BA.debugLine="Reintento = Reintento +1";
_reintento = (int) (_reintento+1);
 //BA.debugLineNum = 229;BA.debugLine="If Resultado=False Then Sleep (200)";
if (true) break;
...
;
 if (true) break;
;
 //BA.debugLineNum = 235;BA.debugLine="If Resultado = False  Then";
...
//C
this.state = 33;
 //BA.debugLineNum = 236;BA.debugLine="ActMosaico.Conectado =False";
parent.mostCurrent._actmosaico._conectado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 237;BA.debugLine="StartActivity(ActMosaico)";
...
//C
this.state = 33;
 //BA.debugLineNum = 239;BA.debugLine="PaqueteEnviado=True";
...
public static String  _slidemenu_click(Object _item) throws Exception{
 //BA.debugLineNum = 266;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 267;BA.debugLine="If Item>99 And  Item < 200 Then";
if ((double)(BA.ObjectToNumber(_item))>99 && (double)(BA.ObjectToNumber(_item))<200) { 
 //BA.debugLineNum = 268;BA.debugLine="ActMosaico.Conectado =False";
mostCurrent._actmosaico._conectado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 269;BA.debugLine="ActMosaico.CentraltoConnect  =Item-100";
...
mostCurrent._activity.Finish();
 ...
 //BA.debugLineNum = 279;BA.debugLine="Select Case Item";
...
case 0: {
 //BA.debugLineNum = 282;BA.debugLine="StartActivity(ActMosaico)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actmosaico.getObject()));
 //BA.debugLineNum = 283;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 break; }
case 1: {
 //BA.debugLineNum = 285;BA.debugLine="StartActivity(ActCircuit)";
...
mostCurrent._activity.Finish();
 break; }
case 2: {
 //BA.debugLineNum = 288;BA.debugLine="StartActivity(ActScene)";
...
mostCurrent._activity.Finish();
 break; }
case 3: {
 //BA.debugLineNum = 291;BA.debugLine="StartActivity(ActNotification)";
...
mostCurrent._activity.Finish();
 break; }
case 4: {
 //BA.debugLineNum = 294;BA.debugLine="StartActivity(ActCondicionados)";
...
case 5: {
 break; }
case 6: {
 //BA.debugLineNum = 300;BA.debugLine="StartActivity(ActSensors)";
...
mostCurrent._activity.Finish();
 break; }
case 7: {
 //BA.debugLineNum = 303;BA.debugLine="If File.Exists ( File.DirInternal ,\"Sensores\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"Sensores"+mostCurrent._valorescomunes._central.Nombre)) { 
 //BA.debugLineNum = 304;BA.debugLine="StartActivity(ActFreeTxt)";
...
mostCurrent._activity.Finish();
 ...
 //BA.debugLineNum = 307;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg127")),anywheresoftware.b4a.keywords.Common.True);
 ...
 break; }
case 8: {
 //BA.debugLineNum = 310;BA.debugLine="StartActivity(ActConsignas)";
...
mostCurrent._activity.Finish();
 break; }
case 9: {
 //BA.debugLineNum = 313;BA.debugLine="ValoresComunes.CloseApp =True";
...
mostCurrent._activity.Finish();
 break; }
case 10: {
 //BA.debugLineNum = 316;BA.debugLine="StartActivity(ActFunciones)";
...
mostCurrent._activity.Finish();
 break; }
case 11: {
 //BA.debugLineNum = 320;BA.debugLine="StartActivity(ActSelectSensores)";
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_msg),anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 187;BA.debugLine="PaqueteEnviado = False";
_paqueteenviado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 188;BA.debugLine="AniCargando.Stop(ImgCargando)";
mostCurrent._anicargando.Stop((android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 189;BA.debugLine="ImgCargando.Visible =False";
mostCurrent._imgcargando.setVisible(anywheresoftware.b4a.keywords.Common.False);
 } 
       catch (Exception e14) {
