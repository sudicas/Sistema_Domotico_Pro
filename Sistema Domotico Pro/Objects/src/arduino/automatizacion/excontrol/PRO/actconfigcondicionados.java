...
public class actconfigcondicionados extends Activity implements B4AActivity{
	public static actconfigcondicionados mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigcondicionados");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actconfigcondicionados).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actconfigcondicionados");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "arduino.automatizacion.excontrol.PRO.actconfigcondicionados", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actconfigcondicionados) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actconfigcondicionados) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return actconfigcondicionados.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actconfigcondicionados) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _he = 0;
 ...
 //BA.debugLineNum = 21;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = Fals";
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout (\"frmconfig\")";
mostCurrent._activity.LoadLayout("frmconfig",mostCurrent.activityBA);
 //BA.debugLineNum = 23;BA.debugLine="Activity.Title =ValoresComunes.GetLanString (\"SCD";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"SCD")));
 //BA.debugLineNum = 25;BA.debugLine="Dim he As Int = 40dip";
_he = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40));
 //BA.debugLineNum = 27;BA.debugLine="ListView1.Height = Activity.Height - he";
mostCurrent._listview1.setHeight((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 28;BA.debugLine="ListView1.Width =Activity.Width";
mostCurrent._listview1.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 30;BA.debugLine="CmdGuardar.Top=Activity.Height-he";
mostCurrent._cmdguardar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 31;BA.debugLine="CmdGuardar.Left = Activity.Width   - (he+4dip)";
mostCurrent._cmdguardar.setLeft((int) (mostCurrent._activity.getWidth()-(_he+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4)))));
 //BA.debugLineNum = 32;BA.debugLine="CmdGuardar.Height =he";
mostCurrent._cmdguardar.setHeight(_he);
 //BA.debugLineNum = 33;BA.debugLine="CmdGuardar.Width =he' Activity.Width";
mostCurrent._cmdguardar.setWidth(_he);
 //BA.debugLineNum = 34;BA.debugLine="CmdGuardar.Text = \"\"'ValoresComunes.GetLanString";
mostCurrent._cmdguardar.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 35;BA.debugLine="CmdGuardar.SetBackgroundImage(ValoresComunes.CmdI";
mostCurrent._cmdguardar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgsave(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 37;BA.debugLine="CmdTerminar.Top=Activity.Height-he";
mostCurrent._cmdterminar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 38;BA.debugLine="CmdTerminar.Height =he";
mostCurrent._cmdterminar.setHeight(_he);
 //BA.debugLineNum = 39;BA.debugLine="CmdTerminar.Width =he";
mostCurrent._cmdterminar.setWidth(_he);
 //BA.debugLineNum = 40;BA.debugLine="CmdTerminar.Left =Activity.Width   - ((he  * 2)";
mostCurrent._cmdterminar.setLeft((int) (mostCurrent._activity.getWidth()-((_he*2)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8)))));
 //BA.debugLineNum = 41;BA.debugLine="CmdTerminar.SetBackgroundImage(ValoresComunes.Cmd";
mostCurrent._cmdterminar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgback(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 42;BA.debugLine="CmdTerminar.Text = \"\"";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="If ValoresComunes.CloseApp =True Then";
...
if (true) return "";
 ...
 //BA.debugLineNum = 52;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = True";
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 53;BA.debugLine="RefrescaPantalla";
_refrescapantalla();
 }else {
...
public static String  _cmdguardar_click() throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Sub CmdGuardar_Click";
 //BA.debugLineNum = 107;BA.debugLine="ValoresComunes.GuardaCondicionados";
mostCurrent._valorescomunes._guardacondicionados(mostCurrent.activityBA);
 //BA.debugLineNum = 108;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString (\"re";
...
public static String  _cmdterminar_click() throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Sub CmdTerminar_Click";
...
mostCurrent._listview1 = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private CmdTerminar As Button";
...
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg112")));
 //BA.debugLineNum = 70;BA.debugLine="Lst.Add (ValoresComunes.GetLanStringDefault(\"DiT\"";
_lst.Add((Object)(mostCurrent._valorescomunes._getlanstringdefault(mostCurrent.activityBA,"DiT","Invisible element")));
 //BA.debugLineNum = 74;BA.debugLine="Dim Opcion As Int";
_opcion = 0;
 //BA.debugLineNum = 75;BA.debugLine="Opcion =InputList( Lst,ValoresComunes.GetLanStrin";
_opcion = anywheresoftware.b4a.keywords.Common.InputList(_lst,BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg75")),(int) (0),mostCurrent.activityBA);
 //BA.debugLineNum = 77;BA.debugLine="If Opcion =0 Then";
if (_opcion==0) { 
...
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 81;BA.debugLine="Dialog.Input = ValoresComunes.Condicionados  (Po";
_dialog.setInput(mostCurrent._valorescomunes._condicionados[_position].Nombre);
 //BA.debugLineNum = 82;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 83;BA.debugLine="Result = Dialog.Show ( ValoresComunes.GetLanStri";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 85;BA.debugLine="ValoresComunes.Condicionados(Position).nombre =";
mostCurrent._valorescomunes._condicionados[_position].Nombre = _dialog.getInput();
 };
 };
 //BA.debugLineNum = 88;BA.debugLine="If Opcion =1 Then";
if (_opcion==1) { 
 //BA.debugLineNum = 89;BA.debugLine="Dim Dialog As InputDialog";
_dialog = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 91;BA.debugLine="Dialog.InputType =  Dialog.INPUT_TYPE_TEXT";
_dialog.setInputType(_dialog.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 92;BA.debugLine="Dialog.Input = ValoresComunes.Condicionados  (Po";
_dialog.setInput(mostCurrent._valorescomunes._condicionados[_position].Descripcion);
 //BA.debugLineNum = 93;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 94;BA.debugLine="Result = Dialog.Show ( ValoresComunes.GetLanStri";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 96;BA.debugLine="ValoresComunes.Condicionados(Position).Descripc";
mostCurrent._valorescomunes._condicionados[_position].Descripcion = _dialog.getInput();
 };
 };
 //BA.debugLineNum = 99;BA.debugLine="If Opcion =2 Then";
if (_opcion==2) { 
 //BA.debugLineNum = 100;BA.debugLine="ValoresComunes.Condicionados(Position).Descripci";
mostCurrent._valorescomunes._condicionados[_position].Descripcion = "";
 //BA.debugLineNum = 101;BA.debugLine="ValoresComunes.Condicionados(Position).Nombre";
mostCurrent._valorescomunes._condicionados[_position].Nombre = "";
 };
 //BA.debugLineNum = 104;BA.debugLine="RefrescaPantalla";
_refrescapantalla();
...
int _c = 0;
 //BA.debugLineNum = 110;BA.debugLine="Sub RefrescaPantalla";
 //BA.debugLineNum = 111;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 112;BA.debugLine="Dim c As Int";
_c = 0;
 //BA.debugLineNum = 113;BA.debugLine="For c=0 To 9";
{
final int step3 = 1;
final int limit3 = (int) (9);
_c = (int) (0) ;
for (;(step3 > 0 && _c <= limit3) || (step3 < 0 && _c >= limit3) ;_c = ((int)(0 + _c + step3))  ) {
 //BA.debugLineNum = 114;BA.debugLine="ListView1.AddTwoLinesAndBitmap  (ValoresComunes.";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence(mostCurrent._valorescomunes._condicionados[_c].Nombre),BA.ObjectToCharSequence(mostCurrent._valorescomunes._condicionados[_c].Descripcion),(android.graphics.Bitmap)(mostCurrent._valorescomunes._checkon(mostCurrent.activityBA).getObject()));
 }
};
