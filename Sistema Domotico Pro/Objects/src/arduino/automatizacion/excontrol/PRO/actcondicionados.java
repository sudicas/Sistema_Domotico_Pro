...
public class actcondicionados extends Activity implements B4AActivity{
	public static actcondicionados mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actcondicionados");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actcondicionados).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "arduino.automatizacion.excontrol.PRO", "arduino.automatizacion.excontrol.PRO.actcondicionados");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "arduino.automatizacion.excontrol.PRO.actcondicionados", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actcondicionados) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actcondicionados) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actcondicionados) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _h = 0;
 ...
 //BA.debugLineNum = 30;BA.debugLine="If ValoresComunes.Centrales .IsInitialized = Fals";
...
if (_firsttime) { 
 ...
 //BA.debugLineNum = 39;BA.debugLine="Activity.LoadLayout (\"frmcondicionados\")";
...
_he = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40));
 //BA.debugLineNum = 46;BA.debugLine="ListView1.Top =52dip";
mostCurrent._listview1.setTop(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52)));
 //BA.debugLineNum = 47;BA.debugLine="ListView1.Height = Activity.Height  - 52dip - he";
mostCurrent._listview1.setHeight((int) (mostCurrent._activity.getHeight()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (52))-_he));
 //BA.debugLineNum = 48;BA.debugLine="ListView1.Width =Activity.Width";
mostCurrent._listview1.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 52;BA.debugLine="CmdGuardar.Top=Activity.Height-he";
mostCurrent._cmdguardar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 53;BA.debugLine="CmdGuardar.Left = Activity.Width   - (he+4dip)";
mostCurrent._cmdguardar.setLeft((int) (mostCurrent._activity.getWidth()-(_he+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4)))));
 //BA.debugLineNum = 54;BA.debugLine="CmdGuardar.Height =he";
mostCurrent._cmdguardar.setHeight(_he);
 //BA.debugLineNum = 55;BA.debugLine="CmdGuardar.Width =he' Activity.Width";
mostCurrent._cmdguardar.setWidth(_he);
 //BA.debugLineNum = 56;BA.debugLine="CmdGuardar.Text = \"\"'ValoresComunes.GetLanString";
mostCurrent._cmdguardar.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 57;BA.debugLine="CmdGuardar.SetBackgroundImage(ValoresComunes.CmdI";
mostCurrent._cmdguardar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgsave(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 59;BA.debugLine="CmdTerminar.Top=Activity.Height-he";
mostCurrent._cmdterminar.setTop((int) (mostCurrent._activity.getHeight()-_he));
 //BA.debugLineNum = 60;BA.debugLine="CmdTerminar.Height =he";
mostCurrent._cmdterminar.setHeight(_he);
 //BA.debugLineNum = 61;BA.debugLine="CmdTerminar.Width =he";
mostCurrent._cmdterminar.setWidth(_he);
 //BA.debugLineNum = 62;BA.debugLine="CmdTerminar.Left =Activity.Width   - ((he  * 2)";
mostCurrent._cmdterminar.setLeft((int) (mostCurrent._activity.getWidth()-((_he*2)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8)))));
 //BA.debugLineNum = 63;BA.debugLine="CmdTerminar.SetBackgroundImage(ValoresComunes.Cmd";
mostCurrent._cmdterminar.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._valorescomunes._cmdimgback(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 64;BA.debugLine="CmdTerminar.Text = \"\"";
mostCurrent._cmdterminar.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 66;BA.debugLine="Dim h As Int";
_h = 0;
 //BA.debugLineNum = 67;BA.debugLine="h=75dip";
_h = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (75));
 //BA.debugLineNum = 70;BA.debugLine="ListView1.TwoLinesAndBitmap .ItemHeight =h";
mostCurrent._listview1.getTwoLinesAndBitmap().setItemHeight(_h);
 //BA.debugLineNum = 71;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Width=h";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setWidth(_h);
 //BA.debugLineNum = 72;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.height=h";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setHeight(_h);
 //BA.debugLineNum = 74;BA.debugLine="ListView1.TwoLinesAndBitmap.Label .Left =h + h/9";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setLeft((int) (_h+_h/(double)9));
 //BA.debugLineNum = 75;BA.debugLine="ListView1.TwoLinesAndBitmap.Label.height  =h/1.8";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setHeight((int) (_h/(double)1.8));
 //BA.debugLineNum = 76;BA.debugLine="ListView1.TwoLinesAndBitmap.Label.Gravity = Bit.O";
mostCurrent._listview1.getTwoLinesAndBitmap().Label.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.LEFT,anywheresoftware.b4a.keywords.Common.Gravity.BOTTOM));
 //BA.debugLineNum = 78;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel .Left =Li";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setLeft(mostCurrent._listview1.getTwoLinesAndBitmap().Label.getLeft());
 //BA.debugLineNum = 79;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.height";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setHeight((int) (_h-mostCurrent._listview1.getTwoLinesAndBitmap().Label.getHeight()));
 //BA.debugLineNum = 80;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.top   = L";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setTop(mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.getHeight());
 //BA.debugLineNum = 81;BA.debugLine="ListView1.TwoLinesAndBitmap.SecondLabel.Gravity =";
mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.LEFT,anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 85;BA.debugLine="sm.Initialize(Activity, Me,  \"SlideMenu\", 42dip,";
mostCurrent._sm._initialize(mostCurrent.activityBA,mostCurrent._activity,actcondicionados.getObject(),"SlideMenu",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (42)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (250)));
 //BA.debugLineNum = 86;BA.debugLine="ValoresComunes.BuldMenus (sm,5)";
mostCurrent._valorescomunes._buldmenus(mostCurrent.activityBA,mostCurrent._sm,(int) (5));
 //BA.debugLineNum = 88;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 359;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 361;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK And sm.isVisib";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK && mostCurrent._sm._isvisible()) { 
 //BA.debugLineNum = 362;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 363;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 367;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_MENU Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_MENU) { 
 //BA.debugLineNum = 368;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
String _trama = "";
 ...
 //BA.debugLineNum = 91;BA.debugLine="If ValoresComunes.CloseApp =True Then";
...
if (mostCurrent._valorescomunes._centrales.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 98;BA.debugLine="If Main.MyLan.IsInitialized = False Then Main.My";
...
mostCurrent._main._mylan.Initialize(processBA,(int) (0),"");};
 //BA.debugLineNum = 99;BA.debugLine="If UDPSocket1.IsInitialized = False Then	Valores";
...
mostCurrent._valorescomunes._iniudp(mostCurrent.activityBA,_udpsocket1);};
 //BA.debugLineNum = 103;BA.debugLine="If ImgCargando.IsInitialized =False Then";
if (mostCurrent._imgcargando.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 104;BA.debugLine="ImgCargando.Initialize (\"ImgCargando\")";
mostCurrent._imgcargando.Initialize(mostCurrent.activityBA,"ImgCargando");
 //BA.debugLineNum = 105;BA.debugLine="ImgCargando.Bitmap = ValoresComunes.Cargando";
mostCurrent._imgcargando.setBitmap((android.graphics.Bitmap)(mostCurrent._valorescomunes._cargando(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 106;BA.debugLine="ImgCargando.Gravity = Gravity.FILL";
mostCurrent._imgcargando.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 107;BA.debugLine="Activity.AddView (ImgCargando,  PerXToCurrent(4";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._imgcargando.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (35),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA));
 ...
 //BA.debugLineNum = 111;BA.debugLine="CmdGuardar.Enabled =False";
mostCurrent._cmdguardar.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 115;BA.debugLine="AniCargando.InitializeRotateCenter( \"AniCargando";
mostCurrent._anicargando.InitializeRotateCenter(mostCurrent.activityBA,"AniCargando",(float) (0),(float) (180),(android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 116;BA.debugLine="AniCargando.Duration  =   1000";
mostCurrent._anicargando.setDuration((long) (1000));
 //BA.debugLineNum = 117;BA.debugLine="AniCargando.RepeatCount =5";
mostCurrent._anicargando.setRepeatCount((int) (5));
 //BA.debugLineNum = 118;BA.debugLine="AniCargando.RepeatMode = AniCargando.REPEAT_R";
mostCurrent._anicargando.setRepeatMode(mostCurrent._anicargando.REPEAT_REVERSE);
 //BA.debugLineNum = 120;BA.debugLine="Dim data() As Byte";
_data = new byte[(int) (0)];
;
 //BA.debugLineNum = 122;BA.debugLine="Dim Trama As String";
_trama = "";
 //BA.debugLineNum = 123;BA.debugLine="If ValoresComunes.central.ConexionSegura Then";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
 //BA.debugLineNum = 124;BA.debugLine="Trama =\"CONENABLE\" & ValoresComunes.Central.Pas";
_trama = "CONENABLE"+mostCurrent._valorescomunes._central.Password;
 }else {
 //BA.debugLineNum = 126;BA.debugLine="Trama =\"CONENABLE\"";
_trama = "CONENABLE";
 };
 //BA.debugLineNum = 129;BA.debugLine="data =Trama.GetBytes (\"UTF8\")";
_data = _trama.getBytes("UTF8");
 //BA.debugLineNum = 130;BA.debugLine="SendTrama(data)";
_sendtrama(_data);
 }else {
...
int _i = 0;
 //BA.debugLineNum = 149;BA.debugLine="Sub ActualizaValores()";
 //BA.debugLineNum = 150;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 152;BA.debugLine="Dim i As Int";
_i = 0;
 //BA.debugLineNum = 153;BA.debugLine="For i =0 To 9";
{
final int step3 = 1;
final int limit3 = (int) (9);
_i = (int) (0) ;
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((int)(0 + _i + step3))  ) {
 //BA.debugLineNum = 155;BA.debugLine="If ValoresComunes.Condicionados (i).Nombre <> \"\"";
if ((mostCurrent._valorescomunes._condicionados[_i].Nombre).equals("") == false) { 
 //BA.debugLineNum = 156;BA.debugLine="If Valores(i)=1   Then";
if (_valores[_i]==1) { 
 //BA.debugLineNum = 157;BA.debugLine="ListView1.AddTwoLinesAndBitmap2 ( ValoresComu";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence(mostCurrent._valorescomunes._condicionados[_i].Nombre),BA.ObjectToCharSequence(mostCurrent._valorescomunes._condicionados[_i].Descripcion),(android.graphics.Bitmap)(mostCurrent._valorescomunes._checkon(mostCurrent.activityBA).getObject()),(Object)(_i));
 }else {
 //BA.debugLineNum = 159;BA.debugLine="ListView1.AddTwoLinesAndBitmap2 (ValoresComun";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence(mostCurrent._valorescomunes._condicionados[_i].Nombre),BA.ObjectToCharSequence(mostCurrent._valorescomunes._condicionados[_i].Descripcion),(android.graphics.Bitmap)(mostCurrent._valorescomunes._checkoff(mostCurrent.activityBA).getObject()),(Object)(_i));
 };
 };
 }
};
...
public static String  _btnshow_click() throws Exception{
 //BA.debugLineNum = 372;BA.debugLine="Sub btnShow_Click";
 //BA.debugLineNum = 373;BA.debugLine="sm.Show";
mostCurrent._sm._show();
...
byte[] _data = null;
int _i = 0;
 //BA.debugLineNum = 274;BA.debugLine="Sub CmdGuardar_Click";
 //BA.debugLineNum = 278;BA.debugLine="Dim LongTrama As Int";
_longtrama = 0;
 //BA.debugLineNum = 279;BA.debugLine="If ValoresComunes.central.ConexionSegura Then";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
 //BA.debugLineNum = 280;BA.debugLine="LongTrama= 22";
_longtrama = (int) (22);
 }else {
 //BA.debugLineNum = 282;BA.debugLine="LongTrama= 14";
_longtrama = (int) (14);
 };
 //BA.debugLineNum = 284;BA.debugLine="Dim data(LongTrama) As Byte";
_data = new byte[_longtrama];
;
 //BA.debugLineNum = 285;BA.debugLine="data(0)=87";
_data[(int) (0)] = (byte) (87);
 //BA.debugLineNum = 286;BA.debugLine="data(1)=67";
_data[(int) (1)] = (byte) (67);
 //BA.debugLineNum = 287;BA.debugLine="data(2)=79";
_data[(int) (2)] = (byte) (79);
 //BA.debugLineNum = 288;BA.debugLine="data(3)=78";
_data[(int) (3)] = (byte) (78);
 //BA.debugLineNum = 289;BA.debugLine="Dim i As Int";
_i = 0;
 //BA.debugLineNum = 292;BA.debugLine="For i =0 To 9";
{
final int step13 = 1;
final int limit13 = (int) (9);
_i = (int) (0) ;
for (;(step13 > 0 && _i <= limit13) || (step13 < 0 && _i >= limit13) ;_i = ((int)(0 + _i + step13))  ) {
 //BA.debugLineNum = 293;BA.debugLine="data(i+4)=Valores(i)+1";
_data[(int) (_i+4)] = (byte) (_valores[_i]+1);
 }
};
 //BA.debugLineNum = 295;BA.debugLine="If ValoresComunes.central.ConexionSegura Then Val";
if (mostCurrent._valorescomunes._central.ConexionSegura) { 
mostCurrent._valorescomunes._completartrama(mostCurrent.activityBA,_data);};
 //BA.debugLineNum = 296;BA.debugLine="SendTrama(data)";
_sendtrama(_data);
 //BA.debugLineNum = 297;BA.debugLine="End Sub";
return "";
}
public static String  _cmdterminar_click() throws Exception{
 //BA.debugLineNum = 270;BA.debugLine="Sub CmdTerminar_Click";
...
mostCurrent._cmdguardar = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Dim CmdTerminar As Button";
...
public static String  _listview1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub ListView1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 168;BA.debugLine="If Valores(Value)=1 Then";
if (_valores[(int)(BA.ObjectToNumber(_value))]==1) { 
 //BA.debugLineNum = 169;BA.debugLine="Valores(Value)=0";
_valores[(int)(BA.ObjectToNumber(_value))] = (byte) (0);
 }else {
 //BA.debugLineNum = 171;BA.debugLine="Valores(Value)=1";
_valores[(int)(BA.ObjectToNumber(_value))] = (byte) (1);
 };
 //BA.debugLineNum = 173;BA.debugLine="ActualizaValores";
_actualizavalores();
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 8;BA.debugLine="Dim Valores(10) As   Byte";
...
anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket _packet = null;
 //BA.debugLineNum = 259;BA.debugLine="Sub SendingTrama (data() As Byte) As Boolean";
 //BA.debugLineNum = 260;BA.debugLine="Try";
try { //BA.debugLineNum = 261;BA.debugLine="Dim Packet As UDPPacket";
_packet = new anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket();
 //BA.debugLineNum = 262;BA.debugLine="Packet.Initialize(data, ValoresComunes.ip, Valor";
_packet.Initialize(_data,mostCurrent._valorescomunes._ip,mostCurrent._valorescomunes._puerto);
 //BA.debugLineNum = 263;BA.debugLine="UDPSocket1.Send(Packet)";
_udpsocket1.Send(_packet);
 //BA.debugLineNum = 264;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e7) {
			processBA.setLastException(e7); //BA.debugLineNum = 266;BA.debugLine="Return False";
...
public ResumableSub_SendTrama(arduino.automatizacion.excontrol.PRO.actcondicionados parent,byte[] _data) {
this.parent = parent;
this._data = _data;
}
arduino.automatizacion.excontrol.PRO.actcondicionados parent;
byte[] _data;
...
_myip = "";
 //BA.debugLineNum = 227;BA.debugLine="If ActMosaico.Forzar3g Then";
if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 228;BA.debugLine="MyIp=ServerSocket1.GetMyIP";
...
//C
this.state = 9;
 //BA.debugLineNum = 230;BA.debugLine="MyIp=ServerSocket1.GetMyWifiIP";
_myip = _serversocket1.GetMyWifiIP();
 if (true) break;
;
 //BA.debugLineNum = 232;BA.debugLine="If MyIp  <> \"127.0.0.1\" Then";
...
//C
this.state = 14;
 //BA.debugLineNum = 233;BA.debugLine="Resultado = True";
...
_reintento = (int) (_reintento+1);
 //BA.debugLineNum = 236;BA.debugLine="Sleep (200)";
...
;
 if (true) break;
;
 //BA.debugLineNum = 240;BA.debugLine="If Resultado = True Then";
...
//C
this.state = 18;
 //BA.debugLineNum = 241;BA.debugLine="Resultado =False";
_resultado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 242;BA.debugLine="Reintento =0";
_reintento = (int) (0);
...
//C
this.state = 21;
 //BA.debugLineNum = 244;BA.debugLine="Resultado = SendingTrama(data)";
_resultado = _sendingtrama(_data);
 //BA.debugLineNum = 245;BA.debugLine="Reintento = Reintento +1";
_reintento = (int) (_reintento+1);
 //BA.debugLineNum = 246;BA.debugLine="If Resultado=False Then Sleep (200)";
if (true) break;
...
;
 if (true) break;
;
 //BA.debugLineNum = 252;BA.debugLine="If Resultado = False  Then";
...
//C
this.state = 33;
 //BA.debugLineNum = 253;BA.debugLine="ActMosaico.Conectado =False";
parent.mostCurrent._actmosaico._conectado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 254;BA.debugLine="StartActivity(ActMosaico)";
...
//C
this.state = 33;
 //BA.debugLineNum = 256;BA.debugLine="PaqueteEnviado=True";
...
public static String  _slidemenu_click(Object _item) throws Exception{
 //BA.debugLineNum = 298;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 299;BA.debugLine="If Item>99 And  Item < 200 Then";
if ((double)(BA.ObjectToNumber(_item))>99 && (double)(BA.ObjectToNumber(_item))<200) { 
 //BA.debugLineNum = 300;BA.debugLine="ActMosaico.Conectado =False";
mostCurrent._actmosaico._conectado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 301;BA.debugLine="ActMosaico.CentraltoConnect  =Item-100";
mostCurrent._actmosaico._centraltoconnect = (int) ((double)(BA.ObjectToNumber(_item))-100);
 //BA.debugLineNum = 302;BA.debugLine="StartActivity(ActMosaico)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actmosaico.getObject()));
...
mostCurrent._activity.Finish();
 ...
 //BA.debugLineNum = 311;BA.debugLine="Select Case Item";
...
case 0: {
 //BA.debugLineNum = 314;BA.debugLine="StartActivity(ActMosaico)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._actmosaico.getObject()));
 //BA.debugLineNum = 315;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 break; }
case 1: {
 //BA.debugLineNum = 317;BA.debugLine="StartActivity(ActCircuit)";
...
mostCurrent._activity.Finish();
 break; }
case 2: {
 //BA.debugLineNum = 320;BA.debugLine="StartActivity(ActScene)";
...
mostCurrent._activity.Finish();
 break; }
case 3: {
 //BA.debugLineNum = 323;BA.debugLine="StartActivity(ActNotification)";
...
case 4: {
 break; }
case 5: {
 //BA.debugLineNum = 329;BA.debugLine="StartActivity(ActComandos)";
...
mostCurrent._activity.Finish();
 break; }
case 6: {
 //BA.debugLineNum = 332;BA.debugLine="StartActivity(ActSensors)";
...
mostCurrent._activity.Finish();
 break; }
case 7: {
 //BA.debugLineNum = 335;BA.debugLine="If File.Exists ( File.DirInternal ,\"Sensores\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"Sensores"+mostCurrent._valorescomunes._central.Nombre)) { 
 //BA.debugLineNum = 336;BA.debugLine="StartActivity(ActFreeTxt)";
...
mostCurrent._activity.Finish();
 ...
 //BA.debugLineNum = 339;BA.debugLine="ToastMessageShow(ValoresComunes.GetLanString";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._valorescomunes._getlanstring(mostCurrent.activityBA,"reg127")),anywheresoftware.b4a.keywords.Common.True);
 ...
 break; }
case 8: {
 //BA.debugLineNum = 342;BA.debugLine="StartActivity(ActConsignas)";
...
mostCurrent._activity.Finish();
 break; }
case 9: {
 //BA.debugLineNum = 345;BA.debugLine="ValoresComunes.CloseApp =True";
...
mostCurrent._activity.Finish();
 break; }
case 10: {
 //BA.debugLineNum = 348;BA.debugLine="StartActivity(ActFunciones)";
...
mostCurrent._activity.Finish();
 break; }
case 11: {
 //BA.debugLineNum = 352;BA.debugLine="StartActivity(ActSelectSensores)";
...
_msg = anywheresoftware.b4a.keywords.Common.BytesToString(_packet.getData(),_packet.getOffset(),_packet.getLength(),"UTF8");
 //BA.debugLineNum = 183;BA.debugLine="If msg.Contains (\"ENCON\") Then";
if (_msg.contains("ENCON")) { 
 //BA.debugLineNum = 184;BA.debugLine="Dim  c As Int";
_c = 0;
 //BA.debugLineNum = 185;BA.debugLine="For c = 5 To Packet.Length -1";
{
final int step6 = 1;
final int limit6 = (int) (_packet.getLength()-1);
_c = (int) (5) ;
for (;(step6 > 0 && _c <= limit6) || (step6 < 0 && _c >= limit6) ;_c = ((int)(0 + _c + step6))  ) {
 //BA.debugLineNum = 186;BA.debugLine="Valores(c - 5)= Packet.Data (c)-1";
_valores[(int) (_c-5)] = (byte) (_packet.getData()[_c]-1);
 //BA.debugLineNum = 187;BA.debugLine="If Valores(c - 5) <> 1 Then Valores(c - 5)= 0";
...
_actualizavalores();
 ...
 //BA.debugLineNum = 195;BA.debugLine="If msg =\"REPETIRMSG\" Then";
if ((_msg).equals("REPETIRMSG")) { 
 //BA.debugLineNum = 196;BA.debugLine="SendTrama(TramaEnviada)";
_sendtrama(_tramaenviada);
...
if (true) return "";
 ...
 //BA.debugLineNum = 202;BA.debugLine="PaqueteEnviado = False";
_paqueteenviado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 203;BA.debugLine="CmdGuardar.Enabled =True";
mostCurrent._cmdguardar.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 204;BA.debugLine="AniCargando.Stop(ImgCargando)";
mostCurrent._anicargando.Stop((android.view.View)(mostCurrent._imgcargando.getObject()));
 //BA.debugLineNum = 205;BA.debugLine="ImgCargando.Visible =False";
