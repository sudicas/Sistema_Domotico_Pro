...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.Title =ValoresComunes.GetLanString ("SCO")
...
Sub ListView1_ItemClick (Position As Int, Value As Object)
	...
	Dim cmd As Scene 
	cmd = ValoresComunes.Comandos.Get (Position)
	If Opcion =0 Then
...
Sub RefrescaPantalla
	...
	For c=0 To ValoresComunes.Comandos.Size -1
		Dim cmd As Scene 
		cmd = ValoresComunes.Comandos.Get (c)
		ListView1.AddTwoLinesAndBitmap  (cmd.Nombre ,cmd.Descripcion,ValoresComunes.Comando )
	Next
	
End Sub 

Sub CmdGuardar_Click
	ValoresComunes.GuardaComandos  
...
Sub CmdNew_Click
	...
	ValoresComunes.Comandos .Add (cmd)
	ValoresComunes.GuardaComandos 
	RefrescaPantalla
End Sub
