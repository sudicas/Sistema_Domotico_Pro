...
Sub Activity_Create(FirstTime As Boolean)
	...
	ListView1.height = PerYToCurrent(85) -52dip
...
Sub Activity_Resume
	...
	If ValoresComunes.Centrales .IsInitialized = True Then
		CmdSelect.Text= ValoresComunes.descripcionesComandos .Get (0)	
...
Sub RefPantalla
	ListView1.Clear 
	Dim i As Int 
	For i =0 To  ValoresComunes.Comandos.Size -1
		Dim cmd As Scene 
		cmd = ValoresComunes.Comandos.Get (i)
		If cmd.Nombre <> "" And cmd.Descripcion = CmdSelect.Text  Then
			ListView1.AddTwoLinesAndBitmap2 ( cmd.Nombre ,cmd.Descripcion  ,ValoresComunes.Comando,i)
		End If	
	Next
End Sub
...
Sub CmdSelect_Click
	...
	Pos =InputList(ValoresComunes.descripcionesComandos,ValoresComunes.GetLanString ("reg75"), Pos)
	If Pos>=0 Then
		CmdSelect.Text  = ValoresComunes.descripcionesComandos.Get (Pos)
		RefPantalla
	End If
End Sub
